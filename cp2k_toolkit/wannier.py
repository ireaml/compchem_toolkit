...
class Wannier_centers:
    ...
    def __init__(
        ...
        struct_copy = Structure.from_sites(atom_sites)  # Real structure without wannier centers
        ...
        self.classification = {}  # Dict like {wannier_index: [(species_string, site_index, distance), ]}
    ...
    def get_wannier_of_site(
        ...
        if isinstance(site_index, int):
            selected_wanniers = {
                k:v for k,v in self.classification.items() if v and v[0][1] == site_index
            }
            if self.verbose:
